...
-- Reset all tables and SERIAL sequences so hardcoded IDs (1-40) are always correct
-- Safe to re-run: tables are empty after a failed/rolled-back migration attempt anyway
TRUNCATE ingredients, dishes, dish_ingredients, recipes, recipe_ingredients RESTART IDENTITY CASCADE;
...
-- ===========================
UPDATE ingredients SET show_in_selector = FALSE WHERE name IN (
...
-- Злаки и мучное
('Хлеб', 'cereals', NULL, FALSE),
('Батон', 'cereals', NULL, FALSE),
('Пшено', 'cereals', NULL, FALSE),
('Манная крупа', 'cereals', NULL, FALSE),
('Перловка', 'cereals', NULL, FALSE),
('Кускус', 'cereals', NULL, FALSE),
('Булгур', 'cereals', NULL, FALSE),
('Панировочные сухари', 'cereals', NULL, FALSE),
('Лаваш', 'cereals', NULL, FALSE),
('Фасоль', 'cereals', NULL, FALSE),
('Чечевица', 'cereals', NULL, FALSE),
-- Мясо/рыба
('Индейка', 'meat', NULL, FALSE),
('Семга', 'meat', NULL, FALSE),
('Треска', 'meat', NULL, FALSE),
('Минтай', 'meat', NULL, FALSE),
('Тунец', 'meat', NULL, FALSE),
('Колбаса', 'meat', NULL, FALSE),
('Ветчина', 'meat', NULL, FALSE),
-- Овощи/грибы
('Шампиньоны', 'vegetables', NULL, FALSE),
('Вешенки', 'vegetables', NULL, FALSE),
('Горошек', 'vegetables', NULL, FALSE),
('Кукуруза', 'vegetables', NULL, FALSE),
('Стручковая фасоль', 'vegetables', NULL, FALSE),
('Авокадо', 'vegetables', NULL, FALSE),
('Листья салата', 'vegetables', NULL, FALSE),
('Руккола', 'vegetables', NULL, FALSE),
('Лук-порей', 'vegetables', NULL, FALSE),
('Базилик', 'vegetables', NULL, FALSE),
('Кинза', 'vegetables', NULL, FALSE),
('Помидоры черри', 'vegetables', NULL, FALSE),
('Спаржа', 'vegetables', NULL, FALSE),
-- Молочные
('Кефир', 'dairy', NULL, FALSE),
('Сливки', 'dairy', NULL, FALSE),
('Йогурт', 'dairy', NULL, FALSE),
('Фета', 'dairy', NULL, FALSE),
('Моцарелла', 'dairy', NULL, FALSE),
('Творожный сыр', 'dairy', NULL, FALSE),
-- Специи и приправы
('Паприка', 'spices', NULL, FALSE),
('Куркума', 'spices', NULL, FALSE),
('Лавровый лист', 'spices', NULL, FALSE),
('Корица', 'spices', NULL, FALSE),
('Мускатный орех', 'spices', NULL, FALSE),
('Орегано', 'spices', NULL, FALSE),
('Перец чили', 'spices', NULL, FALSE),
('Горчица', 'spices', NULL, FALSE),
('Уксус', 'spices', NULL, FALSE),
-- Прочее
('Мёд', 'other', NULL, FALSE),
('Сахар', 'other', NULL, FALSE),
('Майонез', 'other', NULL, FALSE),
('Кетчуп', 'other', NULL, FALSE),
('Оливковое масло', 'other', NULL, FALSE),
('Оливки', 'other', NULL, FALSE),
('Грецкие орехи', 'other', NULL, FALSE),
('Арахис', 'other', NULL, FALSE),
('Изюм', 'other', NULL, FALSE),
('Курага', 'other', NULL, FALSE),
('Консервированная фасоль', 'other', NULL, FALSE),
('Консервированный горошек', 'other', NULL, FALSE)
ON CONFLICT DO NOTHING;
...
VALUES ('Греческий салат', 'Классический салат с помидорами, огурцами, оливками и сыром фета', 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=800', 15, 'easy', 2, 300, TRUE, FALSE, 'mediterranean', 'lunch')
ON CONFLICT DO NOTHING;
...
-- 2. Хумус
INSERT INTO dishes (name, description, image_url, cooking_time, difficulty, servings, estimated_cost, is_vegetarian, is_vegan, cuisine_type, meal_type)
VALUES ('Хумус', 'Нежная паста из нута с лимоном и чесноком', 'https://images.unsplash.com/photo-1577805947697-89e18249d767?w=800', 20, 'easy', 4, 200, TRUE, TRUE, 'mediterranean', 'snack')
ON CONFLICT DO NOTHING;
...
-- 3. Рататуй
INSERT INTO dishes (name, description, image_url, cooking_time, difficulty, servings, estimated_cost, is_vegetarian, is_vegan, cuisine_type, meal_type)
VALUES ('Рататуй', 'Тушёные овощи в средиземноморском стиле', 'https://images.unsplash.com/photo-1572453800999-e8d2d1589b7c?w=800', 50, 'medium', 4, 350, TRUE, TRUE, 'mediterranean', 'dinner')
ON CONFLICT DO NOTHING;
...
-- 4. Дзадзики (Tzatziki)
INSERT INTO dishes (name, description, image_url, cooking_time, difficulty, servings, estimated_cost, is_vegetarian, is_vegan, cuisine_type, meal_type)
VALUES ('Дзадзики', 'Греческий соус из йогурта с огурцом и чесноком', 'https://images.unsplash.com/photo-1571091655789-405eb7a3a3a8?w=800', 10, 'easy', 4, 150, TRUE, FALSE, 'mediterranean', 'snack')
ON CONFLICT DO NOTHING;
